...
public class RLF_SQLQueryPractice {
...
String SelectSQLQuery = "SHOW FULL COLUMNS FROM RLF_Accounts IN RLFDB;";
SelectSQLQuery = "SELECT column_name FROM information_schema.columns WHERE table_name = 'RLF_Accounts';";
executeSelectSQLQuery(SelectSQLQuery);



// Execute a Select SQL Query
String CustomSQLQuery = "SHOW FULL COLUMNS FROM RLF_Accounts IN RLFDB;";
//executeCustomSQLQuery(CustomSQLQuery);

    	
/*************************** END TEST SELECT QUERY ****************************/  

/*************************** START SELECT QUERY ****************************/    	
/*    	
    	// Execute a Select SQL Query
		String SelectSQLQuery = "SELECT * FROM DGXENMDB_Host_Events;";
		executeSelectSQLQuery(SelectSQLQuery);
*/
...
/*
    	// Execute a Select SQL Query
		String CustomSQLQuery = "SELECT * FROM DGXENMDB_Host_Events;";
		executeCustomSQLQuery(CustomSQLQuery);
*/
...
/*	
		...
		String UpdateSQLQuery = "INSERT INTO DGXENMDB_Host_Events ("+
					"Account_ID," +
					"Host_Username," +
					"Event_Name," +
					"Event_Category ," +
