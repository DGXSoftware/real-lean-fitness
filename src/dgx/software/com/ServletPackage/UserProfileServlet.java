/* 
GOAL: Dynamically displays the user homepage once they log in.
...
/* $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ */
		...
		try {
			...
			for(int i = 1 ; i < SQLQueryOutputMetaData.getColumnCount() + 1 ; i++){
				...
				out.println("<p><b>"+ColumnName+" = </b><span>"+CurrentValue+"</span></p>");
		...
		out.println("<h1 class='Center_Text'>Profile Picture</h1>");
		out.println("");
		out.println("<!-- START DYNAMIC HTML -->");
		...
		// Get the SQLQueryOutput
		ResultSet ProfileImageSQLQueryOutput = statement.executeQuery(ProfileImageSQLQuery);
		...
		out.println("<img border='0' src='"+UserProfileImageLocation+"' class='Center_Image' id='UserProfilePrimaryPicture' name='UserProfilePrimaryPicture' alt='Profile Picture' width='230' height='230' />");
		...
		out.println("<img border='0' src='"+DefaultProfileImageLocation+"' class='Center_Image' id='UserProfilePrimaryPicture' name='UserProfilePrimaryPicture' alt='Profile Picture' width='230' height='230' />");
		...
		out.println("<!-- END DYNAMIC HTML -->");
		out.println("");
		out.println("<form action='/ImageFileUploadServlet' enctype='multipart/form-data' method='post'> ");
		out.println("");
		out.println("<br/>");
		out.println("<input type='file' id='UserProfilePictureBrowse' name='UserProfilePictureBrowse' />");
		out.println("<br/>");
		out.println("");
		out.println("<input type='submit' id='UploadUserProfilePictureButton' name='UploadUserProfilePictureButton' value = 'Upload Profile Picture Button' />");
		out.println("");
		out.println("</form>");
		out.println("");
		out.println("</div>");
...
/* END HTML RESPONSE */
		...
		// if an exception occurs, return the error page
			...
			// Respond with an error message
			String ErrorMessage = "Unknown error occurred. Try again later.";
			writeHTMLErrorResponse(Request, Response, out, ErrorMessage);
