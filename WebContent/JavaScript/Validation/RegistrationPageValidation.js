...
function validateFormOnSubmit(CurrentFeedbackDivID) {
	...
	if(isValidConfirmation('RegistrationEMailConfirmation','RegistrationEMailConfirmationIcon',CurrentFeedbackDivID,'RegistrationEMail',false) === false){ ValidationSucceeded = false; ArrayOfValidationFailures.push(document.getElementById(RegistrationErrorFeedbackDivName).innerHTML); }
